...
* 修復了環境感測模組的 RGB LED 積木；
* 加入了 AI 體驗功能，包括表情分析、語音識別，與 CocoCloud 結合控制電子模組更加有趣；
* 加入了更多第三方感測器的編程積木：時鐘模塊、心率感測器、編碼器數據讀取、RFID 數據讀取、GPS 數據讀取；
...
1. 積木工具欄優化及問題修復
	1. 增加了數組積木和運動積木；
	2. 修改了教學板積木樣式，增加了計數器；
	3. 對針教學模組中的 LED 燈，修改為，可分別用 PWM 和正常 DIGITAL 來控制；
2. 界面設計優化及問題修復：
...
1. 在“模組”選項中，添加了“第三方傳感器”模組和“顔色“模組；
2. ”燈光“模組模塊和”屏幕“模組中的顔色選項更換為内嵌式選項；
3. 移除了在左側菜單選項中的”示例文件“，新增“版本日志”選項；
4. 修復部分bug：
	1. 不再重複聲明相同的庫文件；
	2. 為 CodeBender 添加最小寬度，防止部分字體無法看見；
