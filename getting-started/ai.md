...
c.若對著電腦麥克風説話后，電腦無法識別或識別不夠敏感，請前往電腦的「聲音設置」中調整麥克風的靈敏度，或以外接耳麥德方式接入麥克風
...
使用 AI 項目中的「深度學習機器」來訓練不同的事件，訓練完成后，觸發其中的一個事件並通過 Coco Cloud 將數據傳到模組上，使 LED 燈根據人的手勢顯示對應的手勢
