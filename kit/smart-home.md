...
#### 藍牙控制馬達
**注：電機驅動模組不含在智慧家居套件中，如欲使用，請聯繫銷售購買或者獲取樣品**

本項目結合以下模組／配件一起使用：電機驅動模組、主機板模組、2 個 TT 馬達
...
#### 藍牙控制伺服馬達
**注：舵機轉接驅動模組不含在智慧家居套件中，如欲使用，請聯繫銷售購買或者獲取樣品**

本項目結合以下模組／配件一起使用：舵機轉接模組、主機板模組、1 個9g 伺服馬達
